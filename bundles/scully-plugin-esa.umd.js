(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@scullyio/scully'), require('jsdom'), require('fs/promises'), require('marked')) :
    typeof define === 'function' && define.amd ? define('scully-plugin-esa', ['@scullyio/scully', 'jsdom', 'fs/promises', 'marked'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.scully, global.jsdom, global.fs, global.marked));
})(this, (function (scully, jsdom, fs, marked) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Plugin$1 = function (dom, route) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b, codeblocks, _loop_1, i;
        return __generator(this, function (_c) {
            if (!dom)
                return [2 /*return*/, new jsdom.JSDOM()];
            codeblocks = dom.window.document.querySelectorAll('code[class^="language-"]');
            _loop_1 = function (i) {
                var codeblockFileName = null;
                var codeblockFileExtension = null;
                ...
                // @ts-ignore
                var targetClassName = Array.from(codeblocks[i].classList).find(function (className) {
                ...
                if (!codeblockFileName || !codeblockFileExtension || !targetClassName)
                    return "continue";
                // Fix the class name
                var validClassName = "language-" + codeblockFileExtension;
                codeblocks[i].classList.replace(targetClassName, validClassName);
                // Append the filename as a new element
                var filenameLabel = dom.window.document.createElement('span');
                ...
                var filenameLabelContainer = dom.window.document.createElement('div');
                ...
                var filenameLabelSpacer = dom.window.document.createElement('div');
    ...
    scully.registerPlugin('postProcessByDom', 'esaPostProcess', Plugin$1);

    var Plugin = function (routes, config) {
        if (config === void 0) { config = {}; }
        return __awaiter(void 0, void 0, void 0, function () {
            var _a, _b, i, l, route, markdown, markdownLines, endLineOfMetaData, i_1, html, dom, paragraphs, i_2, paragraph, imageElems, i_3, image, e_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!routes) {
                    ...
                    case 1:
                        ...
                        if (!(route.templateFile && route.templateFile.match(/\.md$/))) return [3 /*break*/, 6];
                        _c.label = 2;
                    case 2:
                        _c.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, fs__namespace.readFile(route.templateFile, 'utf-8')];
                    case 3:
                        markdown = _c.sent();
                        markdownLines = markdown.split(/\n/);
                        endLineOfMetaData = 0;
                        for (i_1 = 1; i_1 < markdownLines.length; i_1++) {
                            if (markdownLines[i_1].match(/^---$/)) {
                                endLineOfMetaData = i_1;
                                break;
                            }
                        }
                        markdown = markdownLines.slice(endLineOfMetaData + 1).join('\n');
                        html = marked.marked.parse(markdown);
                        dom = new jsdom.JSDOM(html);
                        // Extract beginning text
                        route.data.beginningText = '';
                        paragraphs = dom.window.document.querySelectorAll('p');
                        for (i_2 = 0; i_2 < paragraphs.length; i_2++) {
                            paragraph = paragraphs[i_2];
                        ...
                        imageElems = dom.window.document.querySelectorAll('img');
                        for (i_3 = 0; i_3 < imageElems.length; i_3++) {
                            image = imageElems[i_3];
                            route.data.imageUrls.push(image.src);
                        }
                        return [3 /*break*/, 5];
                    case 4:
                        e_1 = _c.sent();
                        console.error("[EsaRouteProcess]", e_1);
                        return [3 /*break*/, 5];
    ...
    scully.registerPlugin('routeProcess', 'esaRouteProcess', Plugin, 100);
...
//# sourceMappingURL=scully-plugin-esa.umd.js.map
